...
C.releases = {
  {
    ...
    items = {
      ...
      { 'next', 'Pets bump instead of clipping: they keep off each other, other world screens, you and your target, and stop short of the game\'s walls, floors and ceilings, sliding round to where there is room, using the game\'s own collision. Characters you have not targeted are not avoided yet. Host tests only; not yet tried in game.' },
