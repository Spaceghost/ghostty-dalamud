...
S.schema = {
  ...
  { 'Pets (terminals around your character)', {
    ...
    { 'world.pet.collide.margin', 'slider', 0.02, 0.6, 'Gap to walls, floors and ceilings (yalms)' },
    { 'world.pet.collide.swing', 'slider', 0, 2.5, 'How far round you a pet looks for room (radians)' },
