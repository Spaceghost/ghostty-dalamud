...
M.settings = {
  ...
  ['world.pet.collide.world'] = 'Pets keep off floors and ceilings, and hang on walls like paintings, sliding along them as you move.',
  ...
  ['world.pet.collide.hang'] = 'How long a pet takes to flatten itself against a wall like a painting, and to peel off again.',
  ['world.pet.collide.peel'] = 'How far its own place must be clear of the wall before a hanging pet peels off; more stays put longer.',
  ['world.pet.collide.tuck'] = 'How far a pet lifts its hem when a mob or NPC walks through (Reduce motion: none, it floats up instead).',
  ['world.pet.collide.float'] = 'How high a pet may float, besides tucking its hem up, to let a mob or NPC under.',
