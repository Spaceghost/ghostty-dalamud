...
M.settings = {
  ...
  ['world.pet.collide.swing'] = 'How far round you a pet may drift to find open space before it comes in closer.',
  ['world.pet.collide.drift'] = 'How slowly a pet drifts to a new place; longer is calmer.',
  ['world.pet.collide.stay'] = 'How long a pet stays where it drifted to before it goes back to its own place.',
  ...
  ['world.pet.collide.blink_every'] = 'Blinking out and back in is the last resort, and never more often than this.',
