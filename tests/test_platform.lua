...
-- local ConPTY fallbacks, and Wine keeps exactly the defaults it had.
local ROOT, SCRATCH = ...
...
assert(wine.profiles[1].name == 'shell' and wine.profiles[1].command[1] == '/bin/bash')
